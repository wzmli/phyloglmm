...
```{r glmmTMB}
glmmTMB_fit <- glmmTMBhacked(phen~cofactor+(1|sp)
    , data=datG
    , phyloZ=phyloZ
    , phylonm = "sp"
    , doFit=TRUE
...
glmmTMB_fit2 <- glmmTMBhacked(phen~spec_mean_cf+within_spec_cf+(1|sp) + (1|animals)
    , data=datR
    , phyloZ=phyloZ
    , phylonm = "sp"
    , doFit=TRUE
...
glmmTMB_fit3 <- glmmTMBhacked(phen_pois~cofactor+(1|sp)+(1|obs)
    , data=dat
    , family = poisson
    , phyloZ=phyloZ
    , phylonm = "sp"
