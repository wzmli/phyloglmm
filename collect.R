...
lme4ms_results <- function(tt){
	lme4ms_df <- data.frame(resid = numeric(910)
		, phylo_X = numeric(910)
		, phylo_int = numeric(910)
		, phylo_cor = numeric(910)
		, phylo_interaction = numeric(910)
		, species_X = numeric(910)
		, species_int = numeric(910)
		, species_cor = numeric(910)
		, site_int = numeric(910)
		, B0 = numeric(910)
		, B1 = numeric(910)
		, model = numeric(910)
		, time = numeric(910)
