...
phyr_results <- function(tt){
  phyr_df <- data.frame(resid = numeric(124)
                       , phylo_X = numeric(124)
                       , phylo_int = numeric(124)
                       , phylo_cor = NA
                       , phylo_interaction = numeric(124)
                       , species_X = numeric(124)
                       , species_int = numeric(124)
                       , species_cor = NA
                       , site_int = numeric(124)
                       , B0 = numeric(124)
                       , B1 = numeric(124)
                       , model = numeric(124)
                       , time = numeric(124)
