...
where $SB$ is an $l \times b$ matrix of species--branch relations; $I$ is an identity matrix size $p_i \times s$; $p_i$ is the number of columns contributed by $Z_i$; s is the number of sites; and  $\bigotimes$ is the Kronecker product \ml{cite kronecker}.  
