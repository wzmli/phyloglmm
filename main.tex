...
The second challenge is flexibly-incorportating modelling phylogenetic relationships to other common statistical features with many predictor variables in phylogenetic regression (i.e. phylogenetically correlated slopes, interactions, nested designs and etc.)
