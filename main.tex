...
For example, \mli{ref fig:tree} is a phylogenetic tree with three species, the corresponding $\bS$.
...
$\bS$ is a matrix product of an $n \times b$ indicator matrix $\bS_{id}$ of branch indices, and a branch length vector $\bB$.
For example, \mli{ref fig:tree} is a phylogenetic tree with three species:

\begin{align*}
\bS_{id} = \begin{bmatrix}
1 & 1 & 0 & 0 \\ 
1 & 0 & 1 & 0 \\ 
0 & 0 & 0 & 1
\end{bmatrix} , 
...
\mli{cite ives book for standardizing VCV with the determinate scaling factor}
