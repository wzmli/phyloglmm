...
First, we need a method for incorporating phylogenetic relationships among species into the model of the relationships among traits. \bmb{prev sentence doesn't seem be quite the right lead-in to the rest of the paragraph? You go on to talk about the tip-variation/residual-variation confounding issue. Maybe replace with something talking more specifically about resolving tip variation?}
